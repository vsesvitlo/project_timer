...
/*TimeSpan[] timeSpace = new TimeSpan[] { new TimeSpan(0, 0, 9), new TimeSpan(0, 0, 7) };

DateTime today = new DateTime(2023, 8, 23, 11, 37, 30);
//DateTime today1 = new DateTime(23, 8, 2023, 11, 37, 30);
for (int i = 0; i < timeSpace.Length; i++)
{
    Console.WriteLine(today + timeSpace[i]);
    //Console.WriteLine(today1 + timeSpace[i]);
};*/
...
while (true)
{
    if (counter % 7 == 0)
    {
        Console.WriteLine($"{counter}, {today + new TimeSpan(0, 0, 7 + counter)}");
    }
    if (counter % 9 == 0)
        Console.WriteLine($"{counter}, {today + new TimeSpan(0, 0, 9 + counter)}");
